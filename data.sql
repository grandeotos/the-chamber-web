...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-04-2021 a las 22:50:40
...
INSERT INTO `levelnames` (`levelId`, `levelName`) VALUES
(1, 'TUTORIAL'),
(2, 'NIVEL 1'),
(3, 'NIVEL 2'),
(4, 'NIVEL 3'),
...
--
-- Volcado de datos para la tabla `puzzlenames`
--

INSERT INTO `puzzlenames` (`puzzleId`, `puzzleName`) VALUES
(1, 'PIPE FIXER'),
(2, 'CONSOLE SAYS'),
...
--
-- Volcado de datos para la tabla `teststatus`
--

INSERT INTO `teststatus` (`statusId`, `testStatusName`) VALUES
(1, 'INICIADO'),
(2, 'EN PROCESO'),
(3, 'COMPLETADO'),
(4, 'EXCEPCIÓN REVISAR');
...
INSERT INTO `applicant` (`applicantId`, `firstName`, `lastName`, `email`, `phoneNumber`, `experienceId`, `profileId`, `reviewStatusId`) VALUES
...
INSERT INTO `tests` (`testId`, `accountId`, `beganAtTimeStamp`) VALUES
